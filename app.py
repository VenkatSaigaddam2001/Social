...
MONGO_URI ="mongodb+srv://mahesh01:1801@cluster0.c0zg8he.mongodb.net/"
my_client = pymongo.MongoClient(MONGO_URI, tlsCAFile=certifi.where(),tls=True,tlsInsecure=True)
